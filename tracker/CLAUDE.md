...
- `internal/broker`, `internal/session`, `internal/federation`, and `internal/admission` are the most concurrent modules. Run `go test -race` by default; flakes there are always real bugs.
